    ...
    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col h-full">
      ...
      <div className="px-5 pb-5 flex-grow">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to={`/update/${_id}`}>
            <div className="text-white bg-[#77aa51] btn hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              Update
            </div>
          </Link>
        </div>
      ...
      <Link to={`/details/${_id}`}>
        <button className="text-white bg-[#77aa51] btn hover:text-black w-full">
          Details
        </button>
      </Link>
    </div>
